          ...
          <main className="flex-1 overflow-y-auto p-4 md:p-8">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <Button
                  type="button"
                  // Changed: Used "outline" variant for a different feel
                  variant="outline"
                  onClick={() =>
                    appendTopic({
                      title: '',
...
const SubTopicItem = ({ topicIndex, subTopicIndex, removeSubTopic }: any) => {
  ...
  return (
    <div
      ...
      className="p-4 border rounded-md space-y-4 relative bg-background border-primary/10"
