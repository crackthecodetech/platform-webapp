...
const CourseCard = ({
  ...
  const initializePayment = async () => {
    setIsEnrolling(true);
    try {
      const { order, success, error } = await createRazorpayOrder(course.id);
        ...
        <CardFooter className="px-6 pt-0 mt-auto flex flex-col items-start gap-4">
          {admin ? (
            <div className="w-full space-y-2">
              ...
              <div className="flex w-full gap-y-2 flex-col">
                {analytics ? (
                  ...
                  <Link href={`/admin/update-course/${course.id}`}>
            ...
            <div className="w-full space-y-2">
              ...
              <div className="flex w-full gap-y-2 flex-col">
                <Button onClick={handleOpenCourse} className="w-full">
                  Open Course
                </Button>
                <Button
                  variant="outline"
              ...
              <div className="flex w-full gap-y-2 flex-col">
                {loggedIn ? (
                  ...
                  <SignInButton mode="modal">
                    <Button className="w-full">Sign in to Access</Button>
                  </SignInButton>
                )}
                <Button
                  variant="outline"
