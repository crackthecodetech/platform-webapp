            ...
            <div className="max-w-4xl mx-auto p-4 md:p-8 text-gray-800">
                ...
                <div className="policy-container">
                    ...
                    <p>
                        ...
                        application Crack the Code (“Application”) and its
                        related services. The Application is a sample
                        implementation of an e-learning platform.
                    </p>
                    <h2>
                        What information does the Application obtain and how is
                        it used?
                    </h2>
                    <p>
                    ...
                    <p>
                        The Application obtains the information you provide when
                        you register. Registration with us is required to use
                        the features offered by the Application. When you
                        register with us and use the Application, you generally
                        provide (a) your name, email address, username, and
                        other registration information; (b) transaction-related
                        information, such as when you make purchases; (c)
                        information you provide us when you contact us for help.
                    </p>
                    <p>
                        We may also use the information you provided us to
                        contact you from time to time to provide you with
                    ...
                    <p>
                        This Application does not collect precise information
                    ...
                    <p>
                        ...
                        Application and our service. We will share your
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            necessary to protect our rights, protect your safety
                            or the safety of others, investigate fraud, or
                            respond to a government request;
                        </li>
                        <li>
                            with our trusted services providers who work on our
                            behalf, do not have an independent use of the
                            information we disclose to them, and have agreed to
                            adhere to the rules set forth in this privacy
                            statement.
                        </li>
                    </ul>
                    ...
                    <p>
                        ...
                        Application easily by uninstalling the Application. You
                    ...
                    <p>
                        We will retain User Provided data for as long as you use
                    ...
                    <h2>Children</h2>
                    <p>
                        We do not use the Application to knowingly solicit data
                        from or market to children under the age of 13. If a
                        parent or guardian becomes aware that his or her child
                        has provided us with information without their consent,
                        he or she should contact us at{" "}
                        <strong>crackthecode.tech@gmail.com</strong>. We will
                        delete such information from our files within a
                        reasonable time.
                    </p>
                    <h2>Security</h2>
                    <p>
                        ...
                        that, although we endeavor to provide reasonable
                        security for information we process and maintain, no
                        security system can prevent all potential security
                        breaches.
                    </p>
                    <h2>Changes</h2>
                    <p>
                        ...
                        and informing you via email. You are advised to consult
                        this Privacy Policy regularly for any changes, as
